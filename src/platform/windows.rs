...
pub fn bootstrap() -> bool {
    ...
    #[cfg(not(debug_assertions))]
    {
        // This function will cause `'sciter.dll' was not found neither in PATH nor near the current executable.` when debugging mcpdesk.
...
fn get_pids_with_args_from_wmic_output<S2: AsRef<str>>(
    ...
    // ProcessId=34668
    //
    // CommandLine="C:\Program Files\mcpdesk\mcpdesk.exe" --tray
    // ProcessId=13728
    //
    // CommandLine="C:\Program Files\mcpdesk\mcpdesk.exe"
    // ProcessId=10136
    let mut pids = Vec::new();
