...
const DBUS_NAME: &str = "org.mcpdesk.mcpdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "mcpdesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.mcpdesk.mcpdesk /dbus org.mcpdesk.mcpdesk.NewConnection string:'PEER_ID'`
