...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään mcpdesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa mcpdesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi mcpdeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava mcpdeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava mcpdeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten mcpdesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota mcpdeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli mcpdesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "mcpdesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa mcpdeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "mcpdesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep mcpdesk background service", "Pidä mcpdeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista mcpdeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_mcpdesk_password_tip", "Vahvista mcpdesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "mcpdesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_mcpdesk_server_pro_to_{}_tip", "Päivitä mcpdesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About mcpdesk", "Tietoa mcpdeskistä"),
        ...
        ("upgrade_remote_mcpdesk_client_to_{}_tip", "Päivitä etä-mcpdesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
