...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete mcpdesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), mcpdesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare mcpdesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a mcpdesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a mcpdesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a mcpdesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [mcpdesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep mcpdesk background service", "Mantieni il servizio di mcpdesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione mcpdesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show mcpdesk", "Visualizza mcpdesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a mcpdesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a mcpdesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di mcpdesk."),
        ...
        ("verify_mcpdesk_password_tip", "Conferma password mcpdesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare mcpdesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_mcpdesk_server_pro_to_{}_tip", "Aggiorna mcpdesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di mcpdesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da mcpdesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra mcpdesk è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio mcpdesk in background."),
        ...
        ("upgrade_remote_mcpdesk_client_to_{}_tip", "Aggiorna il client mcpdesk remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, mcpdesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, mcpdesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, mcpdesk non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: il sistema operativo del server mcpdesk non include questa funzionalità."),
