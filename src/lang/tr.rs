...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, mcpdesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, mcpdesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için mcpdesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için mcpdesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, mcpdesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [mcpdesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep mcpdesk background service", "mcpdesk arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki mcpdesk uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için mcpdesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için mcpdesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan mcpdesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_mcpdesk_password_tip", "mcpdesk parolasını doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden mcpdesk'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_mcpdesk_server_pro_to_{}_tip", "Lütfen mcpdesk Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, mcpdesk'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "mcpdesk tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca mcpdesk penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "mcpdesk arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About mcpdesk", "mcpdesk Hakkında"),
        ...
        ("upgrade_remote_mcpdesk_client_to_{}_tip", "Lütfen uzak tarafta mcpdesk istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("update-failed-check-msi-tip", r#"Kurulum yöntemi denetimi başarısız oldu. Sürüm sayfasından indirmek ve manuel olarak yükseltmek için lütfen "İndir" düğmesine tıklayın."#),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, mcpdesk sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda mcpdesk doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, mcpdesk artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: mcpdesk sunucu OSS'si bu özelliği içermemektedir."),
