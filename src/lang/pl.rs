...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "mcpdesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować mcpdesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić mcpdesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić mcpdesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [mcpdesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep mcpdesk background service", "Zachowaj usługę mcpdesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji mcpdesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji mcpdesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z mcpdesk w Twojej sieci."),
        ...
        ("verify_mcpdesk_password_tip", "Weryfikuj hasło mcpdesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu mcpdesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_mcpdesk_server_pro_to_{}_tip", "Proszę zaktualizować mcpdesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu mcpdesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez mcpdesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno mcpdesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę mcpdesk w tle"),
        ...
        ("upgrade_remote_mcpdesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient mcpdesk do wersji {} lub nowszej!"),
